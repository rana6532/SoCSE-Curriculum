...
|---|---|---|
| `README.md` | One-line repo description | Yes |
...
| `Curriculum_Visual_Map.md` | Semester-by-semester map (category, L-T-P-C, level, prerequisites) as a Mermaid graph | When the scheme changes |
