...
# Course File — Object Oriented Programming with Python
...
| Course code | B25EA0301 |
| Course title | Object Oriented Programming with Python |
| Category | HC |
| L-T-P-C | 2-1-1-4 |
...
| Section | ‹…› |
| Academic year | ‹…› |
| Course duration (sessions) | ‹6 contact hrs/week × ‹weeks in semester›› |
