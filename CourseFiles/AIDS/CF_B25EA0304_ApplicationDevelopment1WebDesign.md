---
course_code: "B25EA0304"
title: "Application Development-1: Web Design"
programs: [AIDS, AIML]
semester: III
category: HC
ltpc: "0-0-2-2"
...
# Course File — Application Development-1: Web Design

> **Status: SKELETON** — §0 and §14 totals pre-filled from the 2026 scheme of instruction.
> All other sections require course design. Use the `reva-course-designer` skill
> or follow the [Course Design Workflow](../Course_Design_Workflow.md) to complete this file.

> **Shared course:** this file also covers AIML. Filed under `AIDS/` because both programmes use the same course code.
...
| Course code | B25EA0304 |
| Course title | Application Development-1: Web Design |
| Category | HC |
| L-T-P-C | 0-0-2-2 |
...
| Section | ‹…› |
| Academic year | ‹…› |
| Course duration (sessions) | ‹4 contact hrs/week × ‹weeks in semester›› |
...
- ‹stretch problems or real-world design tasks›
...
|---|---|---|---|---|---|---|---|
| 1 | Test 1 (IA-1) | ‹…› | ‹…› | ‹…› | ‹…› | ‹…› | ‹CO1–CO3› |
| | Test 2 (IA-2) | ‹…› | ‹…› | ‹…› | ‹…› | ‹…› | ‹CO4–CO6› |
| | Assignment 1 | ‹…› | ‹…› | ‹…› | ‹…› | ‹…› | ‹CO1–CO3› |
| | Assignment 2 | ‹…› | ‹…› | ‹…› | ‹…› | ‹…› | ‹CO4–CO6› |
| 2 | SEE | 50 | ‹…› | ‹…› | ‹…› | ‹End of sem› | CO1–CO6 |
| **CIE Total** | | **50** | | | | | |
| **Grand Total** | | **100** | | | | | |
...
| Max % achievable from awareness marks alone | ‹…› |
