---
course_code: "B25CI0102"
title: "Introduction to C Programming Lab"
programs: [CSE, CSIT, ISE, IoT]
semester: I
category: HC
ltpc: "0-0-1-1"
...
# Course File — Introduction to C Programming Lab
...
| REVA ID | ‹…› |
| Email | ‹…› |
| Programme | B.Tech — CSE / CSIT / ISE / IoT |
| Course code | B25CI0102 |
| Course title | Introduction to C Programming Lab |
| Category | HC |
| L-T-P-C | 0-0-1-1 |
...
| Section | ‹…› |
| Academic year | ‹…› |
| Course duration (sessions) | ‹2 contact hrs/week × ‹weeks in semester›› |
